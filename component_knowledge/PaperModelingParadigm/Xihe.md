基于您提供的《XiHe 模型知识提取》文档，我为您系统性地提取并归纳了海洋预报领域（全球高分辨率、解析中尺度涡）AI 建模的通用范式。XiHe 模型展示了如何通过“海陆掩膜约束”与“局地-全局双轨注意力（Local-Global SIE）”架构，在全球 $1/12^\circ$ 的极高分辨率下攻克复杂海洋动力学预报难题。
